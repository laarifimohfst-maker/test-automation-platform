  ...
  return (
    <div style={{ backgroundColor: '#ffffff', borderRadius: '10px', padding: '16px', flex: 1 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
        <div style={{ width: '40px', height: '40px', borderRadius: '50%', backgroundColor: fondIcone, color: couleur || '#0284c7', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>{icone}</div>
        <div>
